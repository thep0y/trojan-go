...
import (
	...
	"github.com/thep0y/trojan-go/tunnel/adapter"
	"github.com/thep0y/trojan-go/tunnel/http"
	"github.com/thep0y/trojan-go/tunnel/mux"
	"github.com/thep0y/trojan-go/tunnel/router"
	"github.com/thep0y/trojan-go/tunnel/shadowsocks"
	"github.com/thep0y/trojan-go/tunnel/simplesocks"
	"github.com/thep0y/trojan-go/tunnel/socks"
	"github.com/thep0y/trojan-go/tunnel/tls"
